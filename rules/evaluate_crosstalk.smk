    ...
    run:
        ...
        for index, row in pairs_df.iterrows():
            ...
            for x in range(len(rights)):
                ...
                spacer_fns = [row['spacer_' + lr] for lr in ['l','r']]
                blast_fnt = '{out_dir}/{in_file}/blast/{target}/filtered/{spacer}.csv'
                blast_filenames = [blast_fnt.format(out_dir=config['spacer_select_dir'],
